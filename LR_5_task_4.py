...
# Завантаження вбудованого датасету (використовуємо fetch_california_housing, бо boston видалений з sklearn)
...
print(f"Explained Variance = {round(explained_variance_score(y_test, y_pred), 2)}")
